...
        adapter_model.set_adapter("caregiver") # Ensure base adapter is active for safety checking
...
        # Slice out the prompt tokens so we only decode the newly generated answer
...
            response_text = "I’m here to help with HPV vaccine communication practice."
            
            
